...
local D = Y.Button({
	...
	Menu = {
		Information = function(self)
			X.Banner({
				Text = "you must be in sellzonet o sell."
			})
		end
	}
})
...
local F = Y.Button({
	...
	Menu = {
		Information = function(self)
			X.Banner({
				Text = "you must select a container before you can use auto store. click the Select Container button and click a container to select it red outline = selecting, Green outline = slected you can not use auto sell and auto store at the same time it will just auto sell."
			})
		end
	}
})
